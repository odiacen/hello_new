<div class="flex flex-col justify-center items-center px-32 mt-20">
    ...
    <div class="flex flex-row justify-center items-center space-x-6 mt-8">
        ...
        <img class="w-36 h-auto" src="https://www.helloflatmate.com/img/img/logo-provincias.png">
    </div>
</div>