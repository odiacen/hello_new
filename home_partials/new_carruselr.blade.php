<div class="mt-48 flex flex-col lg:h-[500px] h-[250px] items-start" x-data="{
  ...
  tabs: [
    ...
    },
    {
      ...
      label: 'Suministros',
      content: 'Las facturas no están incluidas en alojamientos hello rooms, ni hello landlord. Únicamente están incluidas en hello coliving con un tope máximo de 40€ al mes por persona. <br> Helloflatmate hace informes periódicos de las facturas y les notificamos cuando detectamos un uso excesivo; también creamos contenido de interés para el ahorro energético. <br> Los contratos de los suministros van a nombre de la propiedad, para evitar que nuestros flatmates tengan que firmar contratos con empresas privadas de suministros.'
    },
    {
      id: 'tab5',
