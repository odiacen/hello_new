<div x-data="carousel()" x-init="startCarousel()" class="w-full flex flex-col justify-start items-start mt-20 px-36">
    <div class="flex flex-row justify-start items-start w-full">
        ...
        <div class="flex flex-col justify-start items-start ml-10 w-1/3">
            ...
            <button class="bg-[#3f12a3] w-2/3 mt-4 flex flex-row justify-between items-center p-1 rounded-full text-white text-sm font-bold">
                Reserva sin esperas
            ...
            <button class="bg-gray-500 w-2/3 mt-4 flex flex-row justify-between items-center p-1 rounded-full text-white text-sm font-bold">
                ¿Alguna pregunta?
                <span class="bg-white rounded-full p-1 h-6 w-6 flex justify-center items-center ml-2">
                    <ion-icon class="text-black h-4 w-4" name="add-outline"></ion-icon>
                </span>
            </button>
            <button class="bg-cyan-300 w-2/3 mt-4 flex flex-row justify-between items-center p-1 rounded-full text-white text-sm font-bold">
                Como reservar
                <span class="bg-white rounded-full p-1 h-6 w-6 flex justify-center items-center ml-2">
                    <ion-icon class="text-black h-4 w-4" name="add-outline"></ion-icon>
                </span>
