<div x-data="carousel()" x-init="startCarousel()" class="w-full mt-14 lg:mb-28 lg:px-36 px-10">
    <div class="flex flex-row justify-start items-start w-full">
        ...
        <div class="flex flex-col justify-start items-start lg:ml-10 ml-4 lg:w-1/3 w-[25%] lg:mt-20 mt-12">
            <!-- Room price, reservation button, and contact buttons -->
        </div>
    </div>
    ...
    <div class="flex flex-row justify-between mb-10">
        <div class="flex flex-col">
            <button @click="changeTab('photos')" :class="{'bg-gray-400': activeTab === 'photos'}" class="px-4 py-2 text-white bg-gray-800">Fotos</button>
        </div>
        <div class="flex flex-row items-center">
            <button @click="changeTab('map')" :class="{'bg-gray-400': activeTab === 'map'}" class="px-4 py-2 text-white bg-gray-800">Mapa</button>
            <span class="w-px h-4 bg-white mx-2"></span>
            <button @click="changeTab('video')" :class="{'bg-gray-400': activeTab === 'video'}" class="px-4 py-2 text-white bg-gray-800">Video</button>
            <span class="w-px h-4 bg-white mx-2"></span>
            <button @click="changeTab('neighborhood')" :class="{'bg-gray-400': activeTab === 'neighborhood'}" class="px-4 py-2 text-white bg-gray-800">Barrio</button>
            <span class="w-px h-4 bg-white mx-2"></span>
            <button @click="changeTab('moreRooms')" :class="{'bg-gray-400': activeTab === 'moreRooms'}" class="px-4 py-2 text-white bg-gray-800">+Habitaciones</button>
        </div>
    </div>
    ...
    <div x-show="activeTab === 'map'">
        <!-- Map content (e.g., Google Maps embed) -->
    </div>

    <div x-show="activeTab === 'video'">
        <!-- Video content (e.g., YouTube embed) -->
    </div>

    <div x-show="activeTab === 'neighborhood'">
        <!-- Carousel for neighborhood photos -->
    </div>

    <div x-show="activeTab === 'moreRooms'">
        <!-- Carousel for more room photos -->
    </div>
