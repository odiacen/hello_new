    ...
    <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-6">
        ...
        <div class="px-8 w-1/2">
            <template x-for="(question, index) in questions" :key="index">
                <div :class="{'bg-white': question.open, 'bg-neutral-700': !question.open}" class="flex justify-between items-start mb-4 rounded-md p-4">
                    <div>
                    ...
                    <div class="mr-2">
                        <button class="text-white" @click="question.open = !question.open">
