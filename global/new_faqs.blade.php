<div x-data="listFaqs()" class="bg-neutral-700 py-12 px-32 relative">
    <img class="absolute w-48 h-48 top-0 right-0" src="https://www.helloflatmate.com/img/img/vector-circle.png"/>
    <div class="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-6">
        ...
        <div class="px-8">
            ...
            <template x-for="(question, index) in questions" :key="index">
                <div :class="{'bg-white': question.open, 'bg-neutral-700': !question.open}" class="flex flex-row justify-between items-center mb-8 p-4 border-b-2 border-gray-50">
                    <div>
